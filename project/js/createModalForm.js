...
export const createClientsForm = () => {
  ...
  modalTitle.classList.add("modal__title", "section-text");
  ...
  addContactBtn.addEventListener("click", (e) => {
    ...
    if (contactsItems.length < 9) {
      ...
      contactsBlock.style.backgroundColor = "var(--colorAthensGray)";
      ...
      // если будет превышаться лимит заданных контактов, то будем создавать 10 элемент, после которого ничего уже нельзя будет добавить
      const contactItem = createContactItem();
      contactsBlock.prepend(contactItem.contact);
